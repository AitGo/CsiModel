...
import com.liany.csiclient.Zz_SplashActivity;
import com.liany.csiclient.contract.Zz_SplashContract;
import com.liany.csiclient.model.Zz_SplashModel;
 ...
 * @更新描述
 */
public class Zz_SplashPresenter implements Zz_SplashContract.Presenter {
    private Context mContext;
    private Zz_SplashContract.View view;
    private Zz_SplashContract.Model model;

    public Zz_SplashPresenter(Context mContext, Zz_SplashContract.View splashView) {
        this.mContext = mContext;
        this.view = splashView;
        this.model = new Zz_SplashModel(mContext);
    }
            ...
            public void onSuccess(String date) {
                ...
                if(response.getCode() == 200) {
                    ...
                    if (PackageManager.PERMISSION_GRANTED == ContextCompat.checkSelfPermission(mContext, android.Manifest.permission.CAMERA)) {
                        ...
                        ActivityCompat.requestPermissions((Zz_SplashActivity)mContext, perms, Constants.code_permissions_camera);
                    }
                }else {
                    //进入登陆页
