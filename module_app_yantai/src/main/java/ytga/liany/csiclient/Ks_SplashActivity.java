...
import ytga.liany.csiclient.base.AppApplication;
import ytga.liany.csiclient.contract.SplashContract;
import ytga.liany.csiclient.presenter.SplashPresenter;
 ...
 * @更新描述
 */
public class Ks_SplashActivity extends BaseAcitivity implements SplashContract.View, EasyPermissions.PermissionCallbacks {
...
//        presenter.checkIsFirst();
    ...
    public void showScanView() {
        Intent intent = new Intent(Ks_SplashActivity.this, CaptureActivity.class);
    ...
    public void showLoginView(final boolean isShowUpdate) {
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                Intent intent = new Intent(Ks_SplashActivity.this, Ks_LoginActivity.class);
