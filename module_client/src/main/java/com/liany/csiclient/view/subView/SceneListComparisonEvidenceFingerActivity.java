...
import com.liany.csiclient.adapter.CrimeListNoChooseAdapter;
...
import com.liany.csiclient.presenter.subView.SceneListComparisonEvidenceFingerPresenter;
 ...
 * @更新描述
 */
public class SceneListComparisonEvidenceFingerActivity extends BaseAcitivity implements SceneListComparisonEvidenceFingerContract.View, View.OnClickListener {
    RelativeLayout ivTitleBack;
    TextView tvTitle;
    RecyclerView rvScenelist;

    private SceneListComparisonEvidenceFingerContract.Presenter presenter;
    ...
    protected void initData() {
        presenter = new SceneListComparisonEvidenceFingerPresenter(this,this);
    }
    ...
    public void startActivity(Class<?> activity, CrimeItem crimeItem) {
        Intent intent = new Intent(SceneListComparisonEvidenceFingerActivity.this, activity);
        //修改现场
