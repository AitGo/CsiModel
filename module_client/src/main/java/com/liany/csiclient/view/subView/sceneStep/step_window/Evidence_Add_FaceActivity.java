...
import com.liany.csiclient.contract.subView.sceneStep.step_window.EvidenceAddNewFaceContract;
...
import com.liany.csiclient.presenter.subView.sceneStep.step_window.EvidenceAddNewFacePresenter;
 ...
 * @更新描述
 */
public class Evidence_Add_FaceActivity extends BaseAcitivity implements EvidenceAddNewFaceContract.View, View.OnClickListener {
    ...
    private EvidenceAddNewFaceContract.Presenter addPresenter;
    private File outputImagepath;
    private String type = "人像";
    ...
    protected int getLayoutId() {
        return R.layout.activity_step_evidence_add_face;
    }
    ...
    protected void initData() {
        addPresenter = new EvidenceAddNewFacePresenter(this, this);
...
//                startActivity(intent);
            ...
            if (entity.getPhoto() != null && StringUtils.checkString(entity.getPhoto().getServerPath())) {
                Intent photo = new Intent(Evidence_Add_FaceActivity.this, PhotoViewActivity.class);
...
//        startActivityForResult(intent, Constants.REQUEST_EVIDENCE_EVIDENCE_GOOGLE);
    ...
    public void startSelectDictView(int selectType, String title, List<sysDict> dicts, List<Integer> selectList) {
        ...
        intent.setClass(Evidence_Add_FaceActivity.this, Select_RadioList_DictActivity.class);
    ...
    public void startSelectUserView(int selectType, String title, List<selectUser> users, String value) {
        Intent intent = new Intent();
        intent.setClass(Evidence_Add_FaceActivity.this, Select_Check_UserActivity.class);
        intent.putExtra(Constants.SELECT_TITLE, title);
