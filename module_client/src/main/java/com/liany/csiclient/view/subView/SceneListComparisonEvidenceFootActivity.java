...
import com.liany.csiclient.presenter.subView.SceneListComparisonEvidenceFootPresenter;
 ...
 * @更新描述
 */
public class SceneListComparisonEvidenceFootActivity extends BaseAcitivity implements SceneListComparisonEvidenceFootContract.View, View.OnClickListener {
    RelativeLayout ivTitleBack;
    TextView tvTitle;
    RecyclerView rvScenelist;

    private SceneListComparisonEvidenceFootContract.Presenter presenter;
    ...
    protected void initData() {
        presenter = new SceneListComparisonEvidenceFootPresenter(this,this);
    }
    ...
    public void startActivity(Class<?> activity, CrimeItem crimeItem) {
        Intent intent = new Intent(SceneListComparisonEvidenceFootActivity.this, activity);
        //修改现场
