...
import com.liany.csiclient.contract.subView.sceneStep.step_window.EvidenceAddNewOtherContract;
 ...
 * @更新描述
 */
public class EvidenceAddNewOtherModel implements EvidenceAddNewOtherContract.Model {
    private Context mContext;

    public EvidenceAddNewOtherModel(Context context) {
    ...
    @Override
    public void deleteEvidencePhoto(String fileName, String crimeId, callBack callBack) {
        OkGo.<String>post( Constants.ipAddress + "/scene/deletePic")
                .tag(this)
