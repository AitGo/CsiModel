 ...
 * @更新描述 ${TODO}
 */
public class SelectRadio_UnitAdapter extends BaseQuickAdapter<selectUser, BaseViewHolder> {
    ...
    public SelectRadio_UnitAdapter(int layoutResId, @Nullable List<selectUser> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, selectUser item) {
        helper.setText(R.id.tv_select_check,item.getShortName());
