        ...
        OkGo.<String>post( Constants.ipAddress + "/compare/getAllCompareFromService")
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        com.liany.csiclient.diagnose.Response<List<ComparePhoto>> listResponse = GsonUtils.fromJsonArray(response.body(), ComparePhoto.class);
                    ...
                    public void onError(Response<String> response) {
                        ...
                        com.liany.csiclient.utils.LogUtils.e(response.getException().getMessage());
                    }
                });
    }
