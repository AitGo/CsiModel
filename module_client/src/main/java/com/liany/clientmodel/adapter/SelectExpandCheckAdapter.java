...
import com.liany.clientmodel.diagnose.Level0Item;
import com.liany.clientmodel.diagnose.Level1Item;
import com.liany.clientmodel.diagnose.Level2Item;
 ...
 * @更新描述 ${TODO}
 */
public class SelectExpandCheckAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public SelectExpandCheckAdapter(List<MultiItemEntity> data) {
        super(data);
        ...
        switch (helper.getItemViewType()) {
            case TYPE_LEVEL0:
                ...
                helper.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        LogUtils.d("Level 0 item pos check: " + pos);
            ...
            case TYPE_LEVEL1:
                ...
                helper.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        int pos = helper.getLayoutPosition();
                        LogUtils.d("Level 1 item pos check: " + pos);
            ...
            case TYPE_LEVEL2:
                ...
                if(level2Item.getLevel2Value().isCheck()) {
                    ...
                    Iterator<sysDict> iterator = chooseList.iterator();
                    while(iterator.hasNext()){
                        sysDict dict = iterator.next();
                        if(dict.getDictKey().equals(level2Item.getLevel2Value().getValueKey())) {
                            iterator.remove();
                        }
                    }
                }
...
//                        }
    ...
    public List<sysDict> getChooseList() {
        return chooseList;
    }
