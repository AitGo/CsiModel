...
public class ExplosionAnimator extends ValueAnimator {
    ...
    public ExplosionAnimator(BadgeDragView dragBadgeView, Rect rect, Bitmap bitmap) {
        ...
        X = ViewUtils.dp2px(dragBadgeView.getContext(), 5);
        Y = ViewUtils.dp2px(dragBadgeView.getContext(), 20);
        V = ViewUtils.dp2px(dragBadgeView.getContext(), 2);
        W = ViewUtils.dp2px(dragBadgeView.getContext(), 1);
