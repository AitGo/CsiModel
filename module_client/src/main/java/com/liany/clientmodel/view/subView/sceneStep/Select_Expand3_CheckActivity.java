...
import com.liany.clientmodel.adapter.SelectExpandCheckAdapter;
 ...
 * @更新描述 ${TODO}
 */
public class Select_Expand3_CheckActivity extends BaseAcitivity implements View.OnClickListener {
...
//        expandAdapter.expandAll();
    ...
    protected void initData() {
        ...
        value = StringUtils.sysDict2MultiItem3(values);
        value.size();
    }
