...
import com.liany.clientmodel.adapter.SelectRadio_UserAdapter;
 ...
 * @更新描述 ${TODO}
 */
public class Select_Radio_UserActivity extends BaseAcitivity implements View.OnClickListener {
    RelativeLayout ivTitleBack;
    TextView tvTitle;
    ImageView ivTitleConfirm;
    RecyclerView recyclerView;

    private SelectRadio_UserAdapter radioAdapter;
    ...
    protected void initView() {
        ...
        radioAdapter = new SelectRadio_UserAdapter(R.layout.item_adapter_select_radio,itemList);
    ...
    protected void initData() {
        ...
        for(selectUser user : itemList) {
            if(user.getTrueName().equals(checkUser)) {
