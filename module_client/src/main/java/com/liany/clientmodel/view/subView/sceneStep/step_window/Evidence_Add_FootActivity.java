...
import com.liany.clientmodel.presenter.subView.sceneStep.step_window.EvidenceAddNewFootPresenter;
 ...
 * @更新描述
 */
public class Evidence_Add_FootActivity extends BaseAcitivity implements EvidenceAddNewFootContract.View, View.OnClickListener {
    ...
    private EvidenceAddNewFootContract.Presenter addPresenter;
    ...
    protected int getLayoutId() {
        return R.layout.activity_step_evidence_add_foot;
    }
...
//            addPresenter.checkPermission();
        ...
        evidenceTextLabel.setText("足印痕迹");
    ...
    protected void initData() {
        addPresenter = new EvidenceAddNewFootPresenter(this, this);
...
//                Intent intent = new Intent(Evidence_Add_FootActivity.this,QuestionActivity.class);
//                startActivity(intent);
        } else if (id == R.id.iv_evidence_pic) {
            if (entity.getPhoto() != null && StringUtils.checkString(entity.getPhoto().getServerPath())) {
                Intent photo = new Intent(Evidence_Add_FootActivity.this, PhotoViewActivity.class);
    ...
    public void startSelectDictView(int selectType, String title, List<sysDict> dicts, List<Integer> selectList) {
        ...
        intent.setClass(Evidence_Add_FootActivity.this, Select_RadioList_DictActivity.class);
    ...
    public void startSelectUserView(int selectType, String title, List<selectUser> users, String value) {
        Intent intent = new Intent();
        intent.setClass(Evidence_Add_FootActivity.this, Select_Check_UserActivity.class);
        intent.putExtra(Constants.SELECT_TITLE, title);
