 ...
 * @更新描述
 */
public class Compare_Foot_addActivity extends BaseAcitivity implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_step_compare_foot_add;
    }
    ...
    protected void initView() {
        ...
        ivCompare = findViewById(R.id.iv_compare_foot);
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onSuccess(com.lzy.okgo.model.Response<String> response1) {
                            ...
                            if (response.getCode() == 200) {
                                ...
                                intent.setClass(Compare_Foot_addActivity.this, Select_RadioList_DictActivity.class);
                ...
                CompressUtils.compressPic(mContext, outputImagepath, "compress_", new CompressUtils.Callback() {
                    ...
                    public void onSuccess(File file) {
                        ...
                        OkGo.<String>post( Constants.ipAddress + "/scene/uploadPic")
                                ...
                                .params("pic",file)
                                .params("photoId",photoId)
                                .params("state", Constants.photoState_compare_foot)
