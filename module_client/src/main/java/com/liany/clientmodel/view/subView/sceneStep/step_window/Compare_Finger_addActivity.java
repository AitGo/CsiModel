...
import com.liany.clientmodel.utils.NetworkUtils;
...
import com.liany.clientmodel.widget.image.ImageProcessActivity;
 ...
 * @更新描述
 */
public class Compare_Finger_addActivity extends BaseAcitivity implements View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_step_compare_finger_add;
    }
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onSuccess(com.lzy.okgo.model.Response<String> response1) {
                            ...
                            if (response.getCode() == 200) {
                                ...
                                intent.setClass(Compare_Finger_addActivity.this, Select_RadioList_DictActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == Constants.REQUEST_RADIO_DICT) {
            ...
            }else if((requestCode == Constants.REQUEST_EVIDENCE_EVIDENCE_GOOGLE)) {
                ...
                Intent intent = new Intent(Compare_Finger_addActivity.this, ImageProcessActivity.class);
                intent.putExtra("image_filePath",cropPath);
                ...
                OkGo.<String>post( Constants.ipAddress + "/scene/uploadPic")
                        ...
                        .params("pic",file)
                        .params("photoId",photoId)
                        .params("state", Constants.photoState_compare_finger)
